...
const routeConfig: RouteConfig[] = [
  ...
  },
  {
    ...
    requiredRoles: [Role.LeadGuide, Role.Admin],
    showInDrawer: true,
  },
  {
    path: "/bookings",
  ...
  {
    path: "/tour-guide-schedules",
    text: "Schedules",
    component: SchedulesPage,
    requiredRoles: [Role.Guide, Role.LeadGuide, Role.Admin],
    showInDrawer: true,
  },
  {
    path: "/users",
  ...
  },
  {
    ...
    requiredRoles: [Role.Customer, Role.Guide, Role.LeadGuide, Role.Admin],
    showInDrawer: true,
  },
];
