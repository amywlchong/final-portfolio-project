...
import { getBookingsThisMonth, getNumOfBookingsByProperty, numOfBookingsByProperty } from "../../utils/bookingsUtils";
...
const TopTours = ({ bookings, isLoading, error }: TopToursProps) => {
  ...
  const numOfBookingsByTourId: numOfBookingsByProperty<number>[] = getNumOfBookingsByProperty(
