...
public class TourImageController {
    ...
    public byte[] getTourImage(@PathVariable("tourId") Integer tourId, @PathVariable("imageId") Integer imageId) {
    ...
    public ResponseEntity<List<TourImageResponseDTO>> uploadTourImages(
        ...
        return new ResponseEntity<>(tourImageService.uploadTourImages(tourId, files, coverImageName), HttpStatus.CREATED);
    }

    @PreAuthorize("hasAnyRole('LEAD_GUIDE','ADMIN')")
    @DeleteMapping("/{imageId}")
    public ResponseEntity<String> deleteTourImage(@PathVariable("tourId") Integer tourId, @PathVariable("imageId") Integer imageId) {
