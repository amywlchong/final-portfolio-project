...
public class UserAdministrationController {
    ...
    public ResponseEntity<List<UserResponseDTO>> getAvailableGuidesWithinRange(
        ...
        List<UserResponseDTO> availableGuides = userService.findAvailableGuidesWithinRange(startDate, endDate);
    ...
    public ResponseEntity<UserResponseDTO> updateActiveStatus(@Min(1) @PathVariable Integer userId, @NotNull @Valid @RequestBody Map<String, Boolean> requestBody) {
    ...
    public ResponseEntity<UserResponseDTO> updateRole(@Min(1) @PathVariable Integer userId, @NotNull @Valid @RequestBody Map<String, Role> requestBody) {
