...
public interface TourGuideScheduleMapper extends GenericMapper<TourGuideSchedule, ScheduleResponseDTO> {
    ...
    default TourGuideSchedule toTourGuideSchedule(ScheduleRequestDTO requestBody, EntityLookup entityLookup) {
        ...
        tourGuideSchedule.setTourStartDate(mapToTourStartDate(requestBody.getTourId(), requestBody.getStartDateTime(), entityLookup));
