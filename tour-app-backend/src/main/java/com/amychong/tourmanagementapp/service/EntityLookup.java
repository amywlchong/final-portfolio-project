...
public class EntityLookup {
    ...
    @Autowired
    public EntityLookup(UserRepository userRepository, TourRepository tourRepository, TourImageRepository tourImageRepository, TourStartDateRepository tourStartDateRepository, BookingRepository bookingRepository) {
    ...
    public TourImage findTourImageByIdOrThrow(Integer imageId) {
        return tourImageRepository.findById(imageId)
