...
public class ScheduleRequestDTO {
    ...
    @JsonCreator
    public ScheduleRequestDTO(@JsonProperty("userId") Integer userId, @JsonProperty("tourId") Integer tourId, @JsonProperty("startDateTime") LocalDateTime startDateTime) {
        this.userId = userId;
        this.tourId = tourId;
